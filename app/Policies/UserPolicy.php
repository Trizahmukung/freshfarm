...
class UserPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $target_user
     * @return \Illuminate\Auth\Access\Response|bool
     */
    ...
    {
        //
        return in_array("Edit user", $user->simplePermissions);
    }
    ...
    {
        //
        return in_array("Delete user", $user->simplePermissions);
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, User $target_user)
    {
        //
        return in_array("Delete user", $user->simplePermissions);
    }
