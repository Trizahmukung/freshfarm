    ...
    <div>
      ...
      <div class="row">
        <div class="col-sm-12">
              <div class="row">
                <div class="col-sm-10">
              <h4>Reviews</h4></div><div class="col-sm-2"><router-link to="/review/create" class="btn btn-sm btn-warning mb-2"><i class="fa fa-plus"></i> Add review</router-link></div></div>
...
<script>
    ...
    export default {
        name:'reviewIndex',
        created(){
           this.getData(window.location.origin+'/api/review?page=1');
        },
        beforeCreate(){
          this.loading=true;
        },
