    ...
    <div>
      ...
      <div class="row">
        <div class="col-sm-12">
              <div class="row">
                <div class="col-sm-10">
              <h4>Categories</h4></div><div class="col-sm-2"><router-link to="/category/create" class="btn btn-sm btn-warning mb-2"><i class="fa fa-plus"></i> Add category</router-link></div></div>
...
<script>
    ...
    export default {
        name:'categoryIndex',
        created(){
           this.getData(window.location.origin+'/api/category?page=1');
        },
        beforeCreate(){
          this.loading=true;
        },
